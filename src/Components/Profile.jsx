    ...
    return(
        <div>
                ...
                <div className={"mx-[clamp(16px,14vw,250px)] "}>
                    ...
                    <div className={"w-full h-[487px] border-5 border-[rgba(0,121,79,1)] rounded-[50px]"}>
                        <div className={"mx-[6.5%] h-full flex flex-col "}>
                            <h2 className={"text-center text-[rgba(0,121,79,1)] text-[40px] font-bold italic mt-[75px]"}>- Firsttime Design -</h2>
                            <p className={"text-center text-[rgba(0,121,79,1)] text-[48px] [@media(width<=1536px)]:text-[32px] italic mt-[60px]"}>Pengerjaan kami berfokus pada proses perancangan yang <span className={"font-black not-italic"}>terstruktur</span> dan berbasis tujuan <span className={"font-black not-italic"}>komunikasi</span></p>
            ...
            <div className={"mt-[148px]"}>
                ...
                <h1 className={"text-[40px] text-[rgba(0,121,79,1)] [@media(width<=1536px)]:text-[27px] italic text-center mt-[47px]"}>Kami Membantu Klien untuk Memperkuat :</h1>
